...
This is the version the example carries forward.
...
Both numbers come from one run in a session of this size. The point is the ratio being roughly the core count, not the seconds.
